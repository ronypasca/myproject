...
{
    public class MCommunicationTypesDA : BaseDataAccess
    {
        #region Public Property

        public MCommunicationTypes Data { get; set; }

        #endregion

        #region Constructors
        /// <summary>
        /// Default constructor for MCommunicationTypesDA class
        /// </summary>
        public MCommunicationTypesDA()
        {
            Data = new MCommunicationTypes();
        }
        #endregion
        ...
        {
            PropertyInfo m_pifMCommunicationTypes = Data.GetType().GetProperty(fieldName);
            return IsPrimaryKey(m_pifMCommunicationTypes);
        }
        ...
        public override void Insert(bool withTrans, object dbConnection = null)
        {
            ...
            PropertyInfo[] m_arrPifMCommunicationTypes = Data.GetType().GetProperties();

            foreach (PropertyInfo m_pifMCommunicationTypes in m_arrPifMCommunicationTypes)
            {
                object m_objValue = m_pifMCommunicationTypes.GetValue(Data);
                base.SqlParams.Add(new SqlParameter("@in_" + m_pifMCommunicationTypes.Name, m_objValue));
            }
        ...
        public override void Select(object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifMCommunicationTypes in m_arrPifMCommunicationTypes)
            {
                if (IsPrimaryKey(m_pifMCommunicationTypes))
                {
        ...
        public override void Update(bool withTrans, object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifMCommunicationTypes in m_arrPifMCommunicationTypes)
            {
                if (IsPrimaryKey(m_pifMCommunicationTypes))
                {
                    // Do something, to read from the property:
                    object m_objValue = m_pifMCommunicationTypes.GetValue(Data);
                    base.SqlParams.Add(new SqlParameter("@in_Key" + m_pifMCommunicationTypes.Name, m_objValue));
                }
            }
            foreach (PropertyInfo m_pifMCommunicationTypes in m_arrPifMCommunicationTypes)
            {
