...
{
    public class DBudgetPlanVersionMutualDA : BaseDataAccess
    {
        #region Public Property

        public DBudgetPlanVersionMutual Data { get; set; }

        #endregion

        #region Constructors
        /// <summary>
        /// Default constructor for DBudgetPlanVersionMutualDA class
        /// </summary>
        public DBudgetPlanVersionMutualDA()
        {
            Data = new DBudgetPlanVersionMutual();
        }
        #endregion
        ...
        {
            PropertyInfo m_pifDBudgetPlanVersionMutual = Data.GetType().GetProperty(fieldName);
            return IsPrimaryKey(m_pifDBudgetPlanVersionMutual);
        }
        ...
        public override void Insert(bool withTrans, object dbConnection = null)
        {
            ...
            PropertyInfo[] m_arrPifDBudgetPlanVersionMutual = Data.GetType().GetProperties();

            foreach (PropertyInfo m_pifDBudgetPlanVersionMutual in m_arrPifDBudgetPlanVersionMutual)
            {
                object m_objValue = m_pifDBudgetPlanVersionMutual.GetValue(Data);
                base.SqlParams.Add(new SqlParameter("@in_" + m_pifDBudgetPlanVersionMutual.Name, m_objValue));
            }
        ...
        public override void Select(object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifDBudgetPlanVersionMutual in m_arrPifDBudgetPlanVersionMutual)
            {
                if (IsPrimaryKey(m_pifDBudgetPlanVersionMutual))
                {
        ...
        public override void Update(bool withTrans, object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifDBudgetPlanVersionMutual in m_arrPifDBudgetPlanVersionMutual)
            {
                if (IsPrimaryKey(m_pifDBudgetPlanVersionMutual))
                {
                    // Do something, to read from the property:
                    object m_objValue = m_pifDBudgetPlanVersionMutual.GetValue(Data);
                    base.SqlParams.Add(new SqlParameter("@in_Key" + m_pifDBudgetPlanVersionMutual.Name, m_objValue));
                }
            }
            foreach (PropertyInfo m_pifDBudgetPlanVersionMutual in m_arrPifDBudgetPlanVersionMutual)
            {
            ...
            Dictionary<string, List<object>> having, List<string> group, Dictionary<string, OrderDirection> orderBy, object dbConnection = null)
        {
            ...
            if (isCount)
            {
                ...
                "sel_DBudgetPlanVersionMutual_BC",
                dbConnection != null,
                base.SqlParams.ToArray());
        ...
        public override void UpdateBC(Dictionary<string, List<object>> set, Dictionary<string, List<object>> filter, bool withTrans, object dbConnection = null)
        {
            ...
            {
                m_objDBConnection.ExecuteUpdateTrans(CommandType.StoredProcedure,
                "upd_DBudgetPlanVersionMutual_BC",
                base.SqlParams.ToArray());
            }
            else
            {
        ...
        public override void DeleteBC(Dictionary<string, List<object>> filter, bool withTrans, object dbConnection = null)
        {
            ...
            {
                m_objDBConnection.ExecuteUpdateTrans(CommandType.StoredProcedure,
                "del_DBudgetPlanVersionMutual_BC",
                base.SqlParams.ToArray());
            }
            else
            {
