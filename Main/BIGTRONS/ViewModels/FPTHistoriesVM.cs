...
namespace com.SML.BIGTRONS.ViewModels
{
    public class FPTHistoriesVM
    {
        ...
        {
            public static class FPTHistoryID
            {
            ...
            public static string Map(string fieldName, bool withAlias = false)
            {
                ...
                DFPTHistories m_objDFPTHistories = new DFPTHistories();

                if (fieldName == FPTHistoryID.Name)
                    m_strReturn = m_objDFPTHistories.Name + "." + fieldName;
