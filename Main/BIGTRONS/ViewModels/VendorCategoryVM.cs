    ...
    public class VendorCategoryVM
    {
        ...
        public static class Prop
        {
            ...
            public static string Map(string fieldName, bool withAlias = false)
            {
                ...
                if (fieldName == VendorCategoryID.Name)
                    m_strReturn = m_objSVendorCategory.Name + "." + fieldName;
        ...
        {
            PropertyInfo m_pifVendorCategoryVM = this.GetType().GetProperty(fieldName);
            return m_pifVendorCategoryVM != null && Attribute.GetCustomAttribute(m_pifVendorCategoryVM, typeof(KeyAttribute)) != null;
        }
    }
}