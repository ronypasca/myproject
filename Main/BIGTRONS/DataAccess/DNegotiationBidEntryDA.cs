...
{
    public class DNegotiationBidEntryDA : BaseDataAccess
    {
        #region Public Property

        public DNegotiationBidEntry Data { get; set; }

        #endregion

        #region Constructors
        /// <summary>
        /// Default constructor for DNegotiationBidEntryDA class
        /// </summary>
        public DNegotiationBidEntryDA()
        {
            Data = new DNegotiationBidEntry();
        }
        #endregion
        ...
        {
            PropertyInfo m_pifDNegotiationBidEntry = Data.GetType().GetProperty(fieldName);
            return IsPrimaryKey(m_pifDNegotiationBidEntry);
        }
        ...
        public override void Insert(bool withTrans, object dbConnection = null)
        {
            ...
            PropertyInfo[] m_arrPifDNegotiationBidEntry = Data.GetType().GetProperties();

            foreach (PropertyInfo m_pifDNegotiationBidEntry in m_arrPifDNegotiationBidEntry)
            {
                object m_objValue = m_pifDNegotiationBidEntry.GetValue(Data);
                base.SqlParams.Add(new SqlParameter("@in_" + m_pifDNegotiationBidEntry.Name, m_objValue));
            }
        ...
        public override void Select(object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifDNegotiationBidEntry in m_arrPifDNegotiationBidEntry)
            {
                if (IsPrimaryKey(m_pifDNegotiationBidEntry))
                {
        ...
        public override void Update(bool withTrans, object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifDNegotiationBidEntry in m_arrPifDNegotiationBidEntry)
            {
                if (IsPrimaryKey(m_pifDNegotiationBidEntry))
                {
                    // Do something, to read from the property:
                    object m_objValue = m_pifDNegotiationBidEntry.GetValue(Data);
                    base.SqlParams.Add(new SqlParameter("@in_Key" + m_pifDNegotiationBidEntry.Name, m_objValue));
                }
            }
            foreach (PropertyInfo m_pifDNegotiationBidEntry in m_arrPifDNegotiationBidEntry)
            {
