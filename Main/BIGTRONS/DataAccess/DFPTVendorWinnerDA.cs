...
{
    public class DFPTVendorWinnerDA : BaseDataAccess
    {
        #region Public Property

        public DFPTVendorWinner Data { get; set; }

        #endregion

        #region Constructors
        /// <summary>
        /// Default constructor for DFPTVendorWinnerDA class
        /// </summary>
        public DFPTVendorWinnerDA()
        {
            Data = new DFPTVendorWinner();
        }
        #endregion
        ...
        {
            PropertyInfo m_pifDFPTVendorWinner = Data.GetType().GetProperty(fieldName);
            return IsPrimaryKey(m_pifDFPTVendorWinner);
        }
        ...
        public override void Insert(bool withTrans, object dbConnection = null)
        {
            ...
            PropertyInfo[] m_arrPifDFPTVendorWinner = Data.GetType().GetProperties();

            foreach (PropertyInfo m_pifDFPTVendorWinner in m_arrPifDFPTVendorWinner)
            {
                object m_objValue = m_pifDFPTVendorWinner.GetValue(Data);
                base.SqlParams.Add(new SqlParameter("@in_" + m_pifDFPTVendorWinner.Name, m_objValue));
            }
        ...
        public override void Select(object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifDFPTVendorWinner in m_arrPifDFPTVendorWinner)
            {
                if (IsPrimaryKey(m_pifDFPTVendorWinner))
                {
        ...
        public override void Update(bool withTrans, object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifDFPTVendorWinner in m_arrPifDFPTVendorWinner)
            {
                if (IsPrimaryKey(m_pifDFPTVendorWinner))
                {
                    // Do something, to read from the property:
                    object m_objValue = m_pifDFPTVendorWinner.GetValue(Data);
                    base.SqlParams.Add(new SqlParameter("@in_Key" + m_pifDFPTVendorWinner.Name, m_objValue));
                }
            }
            foreach (PropertyInfo m_pifDFPTVendorWinner in m_arrPifDFPTVendorWinner)
            {
