...
{
    public class TFPTAttendancesDA : BaseDataAccess
    {
        #region Public Property

        public TFPTAttendances Data { get; set; }

        #endregion

        #region Constructors
        /// <summary>
        /// Default constructor for TFPTAttendancesDA class
        /// </summary>
        public TFPTAttendancesDA()
        {
            Data = new TFPTAttendances();
        }
        #endregion
        ...
        {
            PropertyInfo m_pifTFPTAttendances = Data.GetType().GetProperty(fieldName);
            return IsPrimaryKey(m_pifTFPTAttendances);
        }
        ...
        public override void Insert(bool withTrans, object dbConnection = null)
        {
            ...
            PropertyInfo[] m_arrPifTFPTAttendances = Data.GetType().GetProperties();

            foreach (PropertyInfo m_pifTFPTAttendances in m_arrPifTFPTAttendances)
            {
                object m_objValue = m_pifTFPTAttendances.GetValue(Data);
                base.SqlParams.Add(new SqlParameter("@in_" + m_pifTFPTAttendances.Name, m_objValue));
            }
        ...
        public override void Select(object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifTFPTAttendances in m_arrPifTFPTAttendances)
            {
                if (IsPrimaryKey(m_pifTFPTAttendances))
                {
        ...
        public override void Update(bool withTrans, object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifTFPTAttendances in m_arrPifTFPTAttendances)
            {
                if (IsPrimaryKey(m_pifTFPTAttendances))
                {
                    // Do something, to read from the property:
                    object m_objValue = m_pifTFPTAttendances.GetValue(Data);
                    base.SqlParams.Add(new SqlParameter("@in_Key" + m_pifTFPTAttendances.Name, m_objValue));
                }
            }
            foreach (PropertyInfo m_pifTFPTAttendances in m_arrPifTFPTAttendances)
            {
