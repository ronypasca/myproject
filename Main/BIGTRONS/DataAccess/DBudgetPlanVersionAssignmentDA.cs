...
{
    public class DBudgetPlanVersionAssignmentDA : BaseDataAccess
    {
        #region Public Property

        public DBudgetPlanVersionAssignment Data { get; set; }

        #endregion

        #region Constructors
        /// <summary>
        /// Default constructor for DBudgetPlanVersionAssignmentDA class
        /// </summary>
        public DBudgetPlanVersionAssignmentDA()
        {
            Data = new DBudgetPlanVersionAssignment();
        }
        #endregion
        ...
        {
            PropertyInfo m_pifDBudgetPlanVersionAssignment = Data.GetType().GetProperty(fieldName);
            return IsPrimaryKey(m_pifDBudgetPlanVersionAssignment);
        }
        ...
        public override void Insert(bool withTrans, object dbConnection = null)
        {
            ...
            PropertyInfo[] m_arrPifDBudgetPlanVersionAssignment = Data.GetType().GetProperties();

            foreach (PropertyInfo m_pifDBudgetPlanVersionAssignment in m_arrPifDBudgetPlanVersionAssignment)
            {
                object m_objValue = m_pifDBudgetPlanVersionAssignment.GetValue(Data);
                base.SqlParams.Add(new SqlParameter("@in_" + m_pifDBudgetPlanVersionAssignment.Name, m_objValue));
            }
            ...
            if (withTrans)
            {
                ...
                "ins_DBudgetPlanVersionAssignment",
        ...
        public override void Select(object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifDBudgetPlanVersionAssignment in m_arrPifDBudgetPlanVersionAssignment)
            {
                if (IsPrimaryKey(m_pifDBudgetPlanVersionAssignment))
                {
            ...
            "sel_DBudgetPlanVersionAssignment",
            dbConnection != null,
            base.SqlParams.ToArray());
        ...
        public override void Update(bool withTrans, object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifDBudgetPlanVersionAssignment in m_arrPifDBudgetPlanVersionAssignment)
            {
                if (IsPrimaryKey(m_pifDBudgetPlanVersionAssignment))
                {
                    // Do something, to read from the property:
                    object m_objValue = m_pifDBudgetPlanVersionAssignment.GetValue(Data);
                    base.SqlParams.Add(new SqlParameter("@in_Key" + m_pifDBudgetPlanVersionAssignment.Name, m_objValue));
                }
            }
            foreach (PropertyInfo m_pifDBudgetPlanVersionAssignment in m_arrPifDBudgetPlanVersionAssignment)
            {
            ...
            {
                m_objDBConnection.ExecuteUpdateTrans(CommandType.StoredProcedure,
                "upd_DBudgetPlanVersionAssignment",
                base.SqlParams.ToArray());
            }
            else
            {
        ...
        public override void Delete(bool withTrans, object dbConnection = null)
        {
            ...
            {
                m_objDBConnection.ExecuteUpdateTrans(CommandType.StoredProcedure,
                "del_DBudgetPlanVersionAssignment",
                base.SqlParams.ToArray());
            }
            else
            {
            ...
            Dictionary<string, List<object>> having, List<string> group, Dictionary<string, OrderDirection> orderBy, object dbConnection = null)
        {
            ...
            if (isCount)
            {
                ...
                "sel_DBudgetPlanVersionAssignment_BC",
                dbConnection != null,
                base.SqlParams.ToArray());
        ...
        public override void UpdateBC(Dictionary<string, List<object>> set, Dictionary<string, List<object>> filter, bool withTrans, object dbConnection = null)
        {
            ...
            {
                m_objDBConnection.ExecuteUpdateTrans(CommandType.StoredProcedure,
                "upd_DBudgetPlanVersionAssignment_BC",
                base.SqlParams.ToArray());
            }
            else
            {
        ...
        public override void DeleteBC(Dictionary<string, List<object>> filter, bool withTrans, object dbConnection = null)
        {
            ...
            {
                m_objDBConnection.ExecuteUpdateTrans(CommandType.StoredProcedure,
                "del_DBudgetPlanVersionAssignment_BC",
                base.SqlParams.ToArray());
            }
            else
            {
