...
namespace com.SML.BIGTRONS.ViewModels
{
    public class TCMembersVM
    {
        ...
        public string SuperiorTCMemberID { get; set; }

        public List<TCMembersDelegationVM> ListTCMembersDelegationVM { get; set; }
        ...
        public static class Prop
        {
            ...
            {
                public static string Desc { get { return "Delegate Start Date"; } }
                public static string Map { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name); } }
                public static string MapAlias { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name, true); } }
                public static string Name { get { return MethodBase.GetCurrentMethod().DeclaringType.Name; } }
            }
            ...
            {
                public static string Desc { get { return "Delegate End Date"; } }
                public static string Map { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name); } }
                public static string MapAlias { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name, true); } }
                public static string Name { get { return MethodBase.GetCurrentMethod().DeclaringType.Name; } }
            }
            ...
            public static class SuperiorTCMemberID
            {
                public static string Desc { get { return "SuperiorTCMemberID"; } }
                public static string Map { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name); } }
                public static string MapAlias { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name, true); } }
                public static string Name { get { return MethodBase.GetCurrentMethod().DeclaringType.Name; } }
            }
            ...
            public static class ListTCMembersDelegationVM
            {
                public static string Desc { get { return "ListTCMembersDelegationVM"; } }
                public static string Map { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name); } }
                public static string MapAlias { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name, true); } }
                public static string Name { get { return MethodBase.GetCurrentMethod().DeclaringType.Name; } }
            }
            ...
            public static class ListTCFunctionVM
            {
                public static string Desc { get { return "ListTCFunctionVM"; } }
                public static string Map { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name); } }
                public static string MapAlias { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name, true); } }
                public static string Name { get { return MethodBase.GetCurrentMethod().DeclaringType.Name; } }
            }
            ...
            public static string Map(string fieldName, bool withAlias = false)
            {
                ...
                if (fieldName == TCMemberID.Name)
                ...
                else if (fieldName == SuperiorTCMemberID.Name)
                    m_strReturn = "[Superior]" + "." + TCMemberID.Name;
                    ...
                    m_strReturn = m_objMEmployee.Name + "." + fieldName;
                else if (fieldName == MiddleName.Name)
                    m_strReturn = m_objMEmployee.Name + "." + fieldName;
                    ...
                    m_strReturn = m_objMBusinessUnit.Name + "." + Descriptions.Name;
