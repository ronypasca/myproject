...
{
    public class ItemVersionChildAltVM
    {
        ...
        public static class Prop
        {
            ...
            public static string Map(string fieldName, bool withAlias = false)
            {
                ...
                if (fieldName == ItemVersionChildID.Name)
                    ...
                    m_strReturn = m_objDItemVersionChildAlt.Name + "." + fieldName;
                else if (fieldName == ChildItemID.Name)
                    m_strReturn = m_objDItemVersionChildAlt.Name + "." + ItemVersionChildAltVM.Prop.ItemID.Name;
