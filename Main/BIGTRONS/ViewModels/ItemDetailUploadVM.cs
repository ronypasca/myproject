...
{
    public class ItemDetailUploadVM
    {
        ...
        {
            public static class ItemDetailUploadID
            {
            ...
            public static string Map(string fieldName, bool withAlias = false)
            {
                ...
                DItemDetailUpload m_objDItemDetails = new DItemDetailUpload();
                ...
                if (fieldName == ItemDetailID.Name)
                    ...
                    m_strReturn = m_objDItemDetails.Name + "." + fieldName;
                else if (fieldName == ItemDetailUploadID.Name)
                    m_strReturn = m_objDItemDetails.Name + "." + fieldName;
