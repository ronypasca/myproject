...
{
    public class ItemVersionChildVM
    {
        ...
        //public decimal? UnitPrice { get { return MaterialAmount ?? 0 + WageAmount ?? 0 + MiscAmount ?? 0; } }
        public decimal? UnitPrice { get; set; }
        public decimal? TotalUnitPrice { get; set; }
        public bool FirstLevel { get; set; }
        public int RowNo { get; set; }

        #region Support Union
        ...
        public static class Prop
        {
            ...
            {
                public static string Desc { get { return "ParentItemTypeID"; } }
                public static string Map { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name); } }
                public static string MapAlias { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name, true); } }
                public static string Name { get { return MethodBase.GetCurrentMethod().DeclaringType.Name; } }
            }
            ...
            {
                public static string Desc { get { return "Unit Price"; } }
                public static string Map { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name); } }
                public static string MapAlias { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name, true); } }
                public static string Name { get { return MethodBase.GetCurrentMethod().DeclaringType.Name; } }
            }
            ...
            {
                public static string Desc { get { return "Total Price"; } }
                public static string Map { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name); } }
                public static string MapAlias { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name, true); } }
                public static string Name { get { return MethodBase.GetCurrentMethod().DeclaringType.Name; } }
            }
            ...
            public static string Map(string fieldName, bool withAlias = false)
            {
                ...
                if (fieldName == ItemVersionChildID.Name)
                    ...
                    m_strReturn = m_objDItemVersionChild.Name + "." + fieldName;
                else if (fieldName == ChildItemTypeID.Name)
                    m_strReturn = m_objMItemGroup.Name + ".ItemTypeID";
