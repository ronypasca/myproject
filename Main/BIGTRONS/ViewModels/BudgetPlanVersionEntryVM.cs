...
{
    public class BudgetPlanVersionEntryVM
    {
        ...
        public static class Prop
        {
            ...
            {
                public static string Desc { get { return "Parent ItemID"; } }
                public static string Map { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name); } }
                public static string MapAlias { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name, true); } }
                public static string Name { get { return MethodBase.GetCurrentMethod().DeclaringType.Name; } }
            }
            ...
            public static string Map(string fieldName, bool withAlias = false)
            {
                ...
                DBudgetPlanVersionEntry m_objSBudgetPlanVersionEntry = new DBudgetPlanVersionEntry();
                ...
                if (fieldName == BudgetPlanID.Name)
                    ...
                    m_strReturn = m_objSBudgetPlanVersionEntry.Name + "." + fieldName;
                    ...
                    m_strReturn = m_objMVendor.Name + "." + BudgetPlanVersionVendorVM.Prop.FirstName.Name + " + ' ' +" + m_objMVendor.Name + "." + BudgetPlanVersionVendorVM.Prop.LastName.Name  ;
                else if (fieldName == Total.Name)
                    m_strReturn = string.Format("SUM({0}.{1} * ({0}.{2} + {0}.{3} + {0}.{4})) * (1+({5}.{6}/100))", m_objSBudgetPlanVersionEntry.Name,Volume.Name,MaterialAmount.Name,WageAmount.Name,MiscAmount.Name, m_objDBudgetPlanVersionVendor.Name, FeePercentage.Name);
