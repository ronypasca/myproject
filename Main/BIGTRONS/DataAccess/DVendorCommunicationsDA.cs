...
{
    public class DVendorCommunicationsDA : BaseDataAccess
    {
        #region Public Property

        public DVendorCommunications Data { get; set; }

        #endregion

        #region Constructors
        /// <summary>
        /// Default constructor for DVendorCommunicationsDA class
        /// </summary>
        public DVendorCommunicationsDA()
        {
            Data = new DVendorCommunications();
        }
        #endregion
        ...
        {
            PropertyInfo m_pifDVendorCommunications = Data.GetType().GetProperty(fieldName);
            return IsPrimaryKey(m_pifDVendorCommunications);
        }
        ...
        public override void Insert(bool withTrans, object dbConnection = null)
        {
            ...
            PropertyInfo[] m_arrPifDVendorCommunications = Data.GetType().GetProperties();

            foreach (PropertyInfo m_pifDVendorCommunications in m_arrPifDVendorCommunications)
            {
                object m_objValue = m_pifDVendorCommunications.GetValue(Data);
                base.SqlParams.Add(new SqlParameter("@in_" + m_pifDVendorCommunications.Name, m_objValue));
            }
        ...
        public override void Select(object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifDVendorCommunications in m_arrPifDVendorCommunications)
            {
                if (IsPrimaryKey(m_pifDVendorCommunications))
                {
        ...
        public override void Update(bool withTrans, object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifDVendorCommunications in m_arrPifDVendorCommunications)
            {
                if (IsPrimaryKey(m_pifDVendorCommunications))
                {
                    // Do something, to read from the property:
                    object m_objValue = m_pifDVendorCommunications.GetValue(Data);
                    base.SqlParams.Add(new SqlParameter("@in_Key" + m_pifDVendorCommunications.Name, m_objValue));
                }
            }
            foreach (PropertyInfo m_pifDVendorCommunications in m_arrPifDVendorCommunications)
            {
