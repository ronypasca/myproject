...
{
    public class CommunicationTypesVM
    {
        ...
        public static class Prop
        {
            ...
            public static string Map(string fieldName, bool withAlias = false)
            {
                ...
                MCommunicationTypes m_objMCommType = new MCommunicationTypes();

                if (fieldName == CommunicationTypeID.Name)
                    m_strReturn = m_objMCommType.Name + "." + fieldName;
