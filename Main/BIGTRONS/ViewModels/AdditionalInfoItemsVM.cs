...
{
    public class AdditionalInfoItemsVM
    {
        ...
        public static class Prop
        {
            ...
            public static string Map(string fieldName, bool withAlias = false)
            {
                ...
                MAdditionalInfoItems m_objMAdditionalInfoItems = new MAdditionalInfoItems();
                

                if (fieldName == FPTAdditionalInfoItemID.Name)
                    m_strReturn = m_objMAdditionalInfoItems.Name + "." + fieldName;
