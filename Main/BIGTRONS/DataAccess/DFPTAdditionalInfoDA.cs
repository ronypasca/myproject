...
{
    public class DFPTAdditionalInfoDA : BaseDataAccess
    {
        #region Public Property

        public DFPTAdditionalInfo Data { get; set; }

        #endregion

        #region Constructors
        /// <summary>
        /// Default constructor for DFPTAdditionalInfoDA class
        /// </summary>
        public DFPTAdditionalInfoDA()
        {
            Data = new DFPTAdditionalInfo();
        }
        #endregion
        ...
        {
            PropertyInfo m_pifDFPTAdditionalInfo = Data.GetType().GetProperty(fieldName);
            return IsPrimaryKey(m_pifDFPTAdditionalInfo);
        }
        ...
        public override void Insert(bool withTrans, object dbConnection = null)
        {
            ...
            PropertyInfo[] m_arrPifDFPTAdditionalInfo = Data.GetType().GetProperties();

            foreach (PropertyInfo m_pifDFPTAdditionalInfo in m_arrPifDFPTAdditionalInfo)
            {
                object m_objValue = m_pifDFPTAdditionalInfo.GetValue(Data);
                base.SqlParams.Add(new SqlParameter("@in_" + m_pifDFPTAdditionalInfo.Name, m_objValue));
            }
        ...
        public override void Select(object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifDFPTAdditionalInfo in m_arrPifDFPTAdditionalInfo)
            {
                if (IsPrimaryKey(m_pifDFPTAdditionalInfo))
                {
        ...
        public override void Update(bool withTrans, object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifDFPTAdditionalInfo in m_arrPifDFPTAdditionalInfo)
            {
                if (IsPrimaryKey(m_pifDFPTAdditionalInfo))
                {
                    // Do something, to read from the property:
                    object m_objValue = m_pifDFPTAdditionalInfo.GetValue(Data);
                    base.SqlParams.Add(new SqlParameter("@in_Key" + m_pifDFPTAdditionalInfo.Name, m_objValue));
                }
            }
            foreach (PropertyInfo m_pifDFPTAdditionalInfo in m_arrPifDFPTAdditionalInfo)
            {
