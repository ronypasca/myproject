...
namespace com.SML.BIGTRONS.ViewModels
{
    public class ItemTypeVM
    {
        ...
        public string ItemTypeParentDesc { get; set; }
        #endregion
        ...
        public static class Prop
        {
            ...
            public static class ItemTypeParentDesc
            {
                public static string Desc { get { return "Parent Description"; } }
                public static string Map { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name); } }
                public static string MapAlias { get { return Map(MethodBase.GetCurrentMethod().DeclaringType.Name, true); } }
                public static string Name { get { return MethodBase.GetCurrentMethod().DeclaringType.Name; } }
            }
            ...
            public static string Map(string fieldName, bool withAlias = false)
            {
                ...
                if (fieldName == ItemTypeID.Name)
                    m_strReturn = m_objMItemType.Name + "." + fieldName;
                else if (fieldName == ItemTypeDesc.Name)
                    m_strReturn = m_objMItemType.Name + "." + fieldName;
                else if (fieldName == ItemTypeParentID.Name)
                    m_strReturn = m_objMItemType.Name + "." + ItemTypeParentID.Name;
                else if (fieldName == ItemTypeParentDesc.Name)
                    m_strReturn = m_objMItemType.Name + "." + ItemTypeParentDesc.Name;
