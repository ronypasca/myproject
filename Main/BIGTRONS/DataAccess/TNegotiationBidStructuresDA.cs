...
{
    public class TNegotiationBidStructuresDA : BaseDataAccess
    {
        #region Public Property

        public TNegotiationBidStructures Data { get; set; }

        #endregion

        #region Constructors
        /// <summary>
        /// Default constructor for TNegotiationBidStructuresDA class
        /// </summary>
        public TNegotiationBidStructuresDA()
        {
            Data = new TNegotiationBidStructures();
        }
        #endregion
        ...
        {
            PropertyInfo m_pifTNegotiationBidStructures = Data.GetType().GetProperty(fieldName);
            return IsPrimaryKey(m_pifTNegotiationBidStructures);
        }
        ...
        public override void Insert(bool withTrans, object dbConnection = null)
        {
            ...
            PropertyInfo[] m_arrPifTNegotiationBidStructures = Data.GetType().GetProperties();

            foreach (PropertyInfo m_pifTNegotiationBidStructures in m_arrPifTNegotiationBidStructures)
            {
                object m_objValue = m_pifTNegotiationBidStructures.GetValue(Data);
                base.SqlParams.Add(new SqlParameter("@in_" + m_pifTNegotiationBidStructures.Name, m_objValue));
            }
        ...
        public override void Select(object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifTNegotiationBidStructures in m_arrPifTNegotiationBidStructures)
            {
                if (IsPrimaryKey(m_pifTNegotiationBidStructures))
                {
        ...
        public override void Update(bool withTrans, object dbConnection = null)
        {
            ...
            foreach (PropertyInfo m_pifTNegotiationBidStructures in m_arrPifTNegotiationBidStructures)
            {
                if (IsPrimaryKey(m_pifTNegotiationBidStructures))
                {
                    // Do something, to read from the property:
                    object m_objValue = m_pifTNegotiationBidStructures.GetValue(Data);
                    base.SqlParams.Add(new SqlParameter("@in_Key" + m_pifTNegotiationBidStructures.Name, m_objValue));
                }
            }
            foreach (PropertyInfo m_pifTNegotiationBidStructures in m_arrPifTNegotiationBidStructures)
            {
            ...
            Dictionary<string, List<object>> having, List<string> group, Dictionary<string, OrderDirection> orderBy, object dbConnection = null)
        {
            ...
            if (isCount)
            {
                ...
                "sel_TNegotiationBidStructures_BC",
                dbConnection != null,
                base.SqlParams.ToArray());
        ...
        public override void UpdateBC(Dictionary<string, List<object>> set, Dictionary<string, List<object>> filter, bool withTrans, object dbConnection = null)
        {
            ...
            {
                m_objDBConnection.ExecuteUpdateTrans(CommandType.StoredProcedure,
                "upd_TNegotiationBidStructures_BC",
                base.SqlParams.ToArray());
            }
            else
            {
        ...
        public override void DeleteBC(Dictionary<string, List<object>> filter, bool withTrans, object dbConnection = null)
        {
            ...
            {
                m_objDBConnection.ExecuteUpdateTrans(CommandType.StoredProcedure,
                "del_TNegotiationBidStructures_BC",
                base.SqlParams.ToArray());
            }
            else
            {
